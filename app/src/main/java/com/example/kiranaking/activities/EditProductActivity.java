...
public class EditProductActivity extends AppCompatActivity {
    ...
    private TextView categoryTv, quantityEt, priceEt, discountedPriceEt, discountedNotEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discountedNotEt = findViewById(R.id.discountedNotEt);
        ...
        discountedNotEt.setVisibility(View.GONE);
        ...
        discountSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    discountedNotEt.setVisibility(View.VISIBLE);
                }
                else {
                    //unchecked, hide discountPriceEt, discountNoteEt
                    discountedPriceEt.setVisibility(View.GONE);
        ...
        reference.child(firebaseAuth.getUid()).child("Products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        discountedNotEt.setText(discountNote);
    ...
    private void inputData() {
        ...
        if (discountAvailable) {
            ...
            discountNote = discountedNotEt.getText().toString().trim();
