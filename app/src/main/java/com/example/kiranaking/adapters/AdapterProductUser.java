...
import com.example.kiranaking.FilterProductUser;
import com.example.kiranaking.R;
import com.example.kiranaking.activities.ShopDetailsActivity;
...
public class AdapterProductUser extends RecyclerView.Adapter<AdapterProductUser.HolderProductUser> implements Filterable {
    ...
    private void showQuantityDialog(ModelProduct modelProduct) {
        ...
        String discountedNote = modelProduct.getDiscountNote();
        ...
        //decrement quantity of product, only of quantity is > 1
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //add to db(SQLite)
                addToCart(productId, title, totalPrice, priceEach, quantity);
    ...
    private void addToCart(String productId, String title, String price, String priceEach, String quantity) {
        itemId++;
