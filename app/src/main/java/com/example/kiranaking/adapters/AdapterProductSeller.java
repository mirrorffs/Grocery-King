package com.example.kiranaking.adapters;
...
import com.example.kiranaking.FilterProduct;
import com.example.kiranaking.R;
import com.example.kiranaking.activities.EditProductActivity;
...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailsBottomSheet(modelProduct); //here modelProduct contains details f clicked product
            }
        });
    }
    ...
    private void detailsBottomSheet(ModelProduct modelProduct) {
        ...
        TextView tilteTv = view.findViewById(R.id.tilteTv);
        ...
        discountedNotTv.setText(discountNote);
    ...
    class HolderProductSeller extends RecyclerView.ViewHolder {
        ...
        private TextView discountedNoteTv, tilteTv, quantityTv, discountedPriceTv, originalPriceTv;
        ...
        public HolderProductSeller(@NonNull View itemView) {
            ...
            tilteTv = itemView.findViewById(R.id.tilteTv);
