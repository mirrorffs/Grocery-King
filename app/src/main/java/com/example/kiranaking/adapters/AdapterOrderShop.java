...
import com.example.kiranaking.FilterOrderShop;
import com.example.kiranaking.R;
import com.example.kiranaking.activities.OrderDetailsSellerActivity;
import com.example.kiranaking.activities.OrderDetailsUsersActivity;
...
public class AdapterOrderShop extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderOrderShop holder, int position) {
        ...
        String formatedDate = DateFormat.format("dd/MM/yyyy", calendar).toString();   //e.g. 15/3/2021
